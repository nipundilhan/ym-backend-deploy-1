...
async function authenticate(req, res) {
    ...
    try {
        ...
        res.json({ user: { username: user.username, userId : user._id,  role: user.role , avatarCode :  user.avatarCode , companyCode :  user.company , department :  user.department}, jwtToken: token });
    } catch (error) {
